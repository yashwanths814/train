            ...
            <div className="bg-white/90 backdrop-blur rounded-3xl shadow-xl border border-purple-100/70 p-4 md:p-7 space-y-7 text-xs md:text-sm">
              ...
              <section>
                ...
                <p className="text-[11px] text-gray-500 mb-4">
                  These details are provided by the manufacturer and cannot be
              ...
              <section>
                ...
                <p className="text-[11px] text-gray-500 mb-4">
                  ...
                  details. Ensure GPS and Jio Tag image match the installed
                  location.
                </p>
                ...
                <div className="mb-4 space-y-1.5">
                  ...
                  <p className="text-[10px] text-gray-400">
                    Tip: Use the “Detect GPS” button when standing near the
                    installed material for accurate coordinates.
                  </p>
                </div>
...
/* Small helper for readonly fields */
