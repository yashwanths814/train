...
export default function DepotMaterialClient() {
            ...
            <div className="bg-white shadow-xl rounded-3xl p-5 sm:p-8 border space-y-8 sm:space-y-10">
              <Section title="Manufacturer & Technical Details">
                <Grid>
                  ...
                  <Info label="Expected Life (Years)" value={m.expectedLifeYears} />
                  <Info label="Purchase Order Number" value={m.purchaseOrderNumber} />
